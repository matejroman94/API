...
namespace Database.Migrations
{
    ...
    [Migration("20230324102011_TransferReason")]
    partial class TransferReason
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.TransferReason", b =>
                {
                    b.Property<int>("TransferReasonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("TransferReasonId"), 1L, 1);

                    b.Property<string>("Description")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("TransferReasonId");

                    b.ToTable("TransferReason", "statistics");
                });
            ...
            modelBuilder.Entity("Domain.Models.Client", b =>
                {
                    ...
                    b.HasOne("Domain.Models.TransferReason", "TransferReason")
                        .WithMany("Clients")
